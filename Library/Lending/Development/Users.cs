...
public class Users : ICanProvideUsers
{
    ...
    [
        CreateUser("00000000-2000-0000-0000-000000000001", "Head Librarian", "librarian@library.local"),
        CreateUser("00000000-2000-0000-0000-000000000002", "Regular Borrower", "borrower@library.local"),
    ]);
